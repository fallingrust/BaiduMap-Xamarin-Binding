...
namespace Com.Baidu.Mapapi.Common {
	...
	public partial class AppTools : global::Java.Lang.Object {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/baidu/mapapi/common/AppTools", typeof (AppTools));
		...
		public static unsafe string BaiduMapToken {
			...
			get {
				const string __id = "getBaiduMapToken.()Ljava/lang/String;";
				try {
