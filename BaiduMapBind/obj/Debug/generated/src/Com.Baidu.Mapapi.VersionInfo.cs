...
namespace Com.Baidu.Mapapi {
	...
	public partial class VersionInfo : global::Java.Lang.Object {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='com.baidu.mapapi']/class[@name='VersionInfo']/field[@name='VersionInfomation']"
		[Register ("VersionInfomation")]
		public const string VersionInfomation = (string) "6_0_0";
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("com/baidu/mapapi/VersionInfo", typeof (VersionInfo));
